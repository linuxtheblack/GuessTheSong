...
window.player = function () {
  return {
    ...
    init: function init() {
      ...
      axios.get('/list/1').then(function (response) {
        _this.playlist = response.data;

        _this.scramblePlaylist();

        _this.nextSong();

        window.setInterval(function () {
          _this.counter = 30 - _.floor(_this.howl.seek());
        }, 100);
      });
    },
    play: function play() {
    ...
    scramblePlaylist: function scramblePlaylist() {
      if (this.playlist) {
    ...
    nextSong: function nextSong() {
      ...
      var src = _.sample(this.playlist);
      ...
      this.howl = new howler__WEBPACK_IMPORTED_MODULE_1__["Howl"]({
        src: src['url']
      });
      this.played.push(src);
      return true;
    },
    toggleGamemaster: function toggleGamemaster() {
...
__webpack_require__(/*! C:\laragon\www\GuessTheSong\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\GuessTheSong\resources\css\app.css */"./resources/css/app.css");
